...
ActiveRecord::Schema.define(version: 20181106102721) do
  ...
  create_table "notification_properties", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
